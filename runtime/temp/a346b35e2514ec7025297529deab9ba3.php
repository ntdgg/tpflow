<?php /*a:2:{s:51:"D:\tpflow\application\index\view\flow\do_check.html";i:1522366025;s:46:"D:\tpflow\application\index\view\pub\base.html";i:1521724601;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<input type="hidden" value="<?php echo htmlentities($flowinfo['nexprocess']['id']); ?>" name="npid">
		<table class="table table-border table-bordered table-bg" style='width:98%'>
			...
			<td style='height:80px'>
				...
				<th><?php echo htmlentities($flowinfo['nexprocess']['process_name']); ?></th>
				</tr>
				<tr style='display:none' id='back_process'>
				<th style='width:30px'>回退步骤</th>
				<th>
					<span class="select-box">
					<select name="wf_backflow" id='backflow'  class="select"  datatype="*" >
