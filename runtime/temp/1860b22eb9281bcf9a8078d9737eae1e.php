<?php /*a:2:{s:78:"C:\Users\Administrator\web\tpflow\application/index/view\flowdesign\index.html";i:1520500095;s:73:"C:\Users\Administrator\web\tpflow\application/index/view\Public\base.html";i:1520499604;}*/ ?>
<!DOCTYPE HTML>
<html>
 <head>
...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      ...
      <div class="nav-collapse collapse">
        <ul class="nav">
           <a class="brand" href="<?php echo url('/demo'); ?>" target="_blank">DEMO</a>
    ...
    var _canvas = $("#flowdesign_canvas").Flowdesign({
                      ...
                      ,canvasMenus:{
                        "cmAdd": function(t) {
                            ...
                            var url = "<?php echo url('/Flowdesign/add_process'); ?>";
                        ...
                        "cmSave": function(t) {
                            ...
                            var url = "<?php echo url('/Flowdesign/save_canvas'); ?>";
                      ...
                      ,processMenus: {
                          ...
                          "pmDelete":function(t)
                          {
                              ...
                              {
                                    var activeId = _canvas.getActiveId();//右键当前的ID
                                    var url = "<?php echo url('/Flowdesign/delete_process'); ?>";
                          ...
                          {
                              var activeId = _canvas.getActiveId();//右键当前的ID
                              var url = "<?php echo url('/Flowdesign/attribute/id/"+activeId+"'); ?>";
                          ...
                          "pmForm": function(t) {
                                var activeId = _canvas.getActiveId();//右键当前的ID
                                var url = "<?php echo url('/Flowdesign/attribute/op/form/id/"+activeId+"'); ?>";
                                ajaxModal(url,function(){
                                    //alert('加载完成执行')
                                });
                          },
                          "pmJudge": function(t) {
                                var activeId = _canvas.getActiveId();//右键当前的ID
                                var url = "<?php echo url('/Flowdesign/attribute/op/judge/id/"+activeId+"'); ?>";
                                ajaxModal(url,function(){
                                    //alert('加载完成执行')
                                });
                          },
                          "pmSetting": function(t) {
                                var activeId = _canvas.getActiveId();//右键当前的ID
                                var url = "<?php echo url('/Flowdesign/attribute/op/style/id/"+activeId+"'); ?>";
                                ajaxModal(url,function(){
                                    //alert('加载完成执行')
                                });
                          }
