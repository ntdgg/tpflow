<?php /*a:2:{s:51:"D:\tpflow\application/index/view\flow\do_check.html";i:1521357162;s:46:"D:\tpflow\application/index/view\pub\base.html";i:1516702710;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('do_check_save'); ?>" method="post" name="form" id="form">
...
<input type="hidden" value="<?php echo htmlentities($flowinfo['run_id']); ?>" name="run_id">
		<table class="table table-border table-bordered table-bg" style='width:98%'>
			...
			<td style='height:80px'>
				...
				<button name="submit_to_save" class="btn btn-primary radius" value='ok' type="submit">提交</button> 
				<button name="submit_to_save" class="btn btn-primary radius" value='back' type="submit">回退</button> 
				<button name="submit_to_save" class="btn btn-primary radius" value='sing' type="submit">会签</button>
				</td>
				</tr>
				</table>
			</td>
		...
		<iframe src="<?php echo url('news/view',['id'=>2]); ?>" id="iframepage" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" onLoad="iFrameHeight()"></iframe>
