...
CREATE TABLE `t_wf_event`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 流程事件表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_flow`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_flow_process`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流设计主表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_kpi_data`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流用户绩效明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_kpi_month`  (
  ...
  `k_create_time` int NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 用户绩效月度绩效' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_kpi_year`  (
  ...
  `k_create_time` int NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流绩效年度总表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流运行主表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_run_process`  (
  ...
  INDEX `is_del`(`is_del`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流运行步骤表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_wf_run_sign`  (
  ...
  INDEX `uid`(`uid`) USING BTREE,
  INDEX `run_id`(`run_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流会签记录表' ROW_FORMAT = DYNAMIC;
