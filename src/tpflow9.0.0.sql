/*
 ...
 Source Schema         : gadmin8

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 17/12/2025 19:58:58
*/
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流实务信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_run_sign`  (
  ...
  `sign_uids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '会签人员存档',
  `run_id` int UNSIGNED NOT NULL DEFAULT 0,
  `run_flow` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '流程ID,子流程时区分run step',
  `run_flow_process` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '当前步骤编号',
...
CREATE TABLE `g_wf_run_process_msg`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 消息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_run_process_cc`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 流程抄送表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流运行步骤表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_run_log`  (
  ...
  `signature` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '签名数据：base64',
  `run_process_id` int NULL DEFAULT NULL COMMENT '运行节点',
  `run_process_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '运行名称',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`) USING BTREE,
  INDEX `run_id`(`run_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_run`  (
  ...
  INDEX `uid`(`uid`) USING BTREE,
  INDEX `is_del`(`is_del`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流运行主表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for g_wf_phrase
-- ----------------------------
DROP TABLE IF EXISTS `g_wf_phrase`;
CREATE TABLE `g_wf_phrase`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 审批常用语表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `g_wf_kpi_year`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流绩效年度总表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_kpi_month`  (
  ...
  `k_create_time` int NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 用户绩效月度绩效' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_kpi_data`  (
  ...
  `k_create_time` int NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 75 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流用户绩效明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_flow_process`  (
  ...
  `is_time` int NOT NULL DEFAULT 0,
  `form_set_hide` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '隐藏字段',
  `form_set_hide_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '隐藏字段名称',
  `rule_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '灵动规则名称',
  `trigger_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '触发器名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流设计主表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_flow`  (
  ...
  `is_signature` tinyint NULL DEFAULT 0 COMMENT '0不需要签名，1需要签名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 工作流表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_entrust_rel`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 流程授权关系表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `g_wf_entrust`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程 - 委托授权表' ROW_FORMAT = DYNAMIC;
